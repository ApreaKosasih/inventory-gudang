...
/**
* User Class untuk membuat account dan keperluan login
*/
class User
{
	...
	//User sudah registered atau tidak
	...
	public function createUserAccount($username,$email,$password,$usertype){
		//untuk melindungi aplikasi dari sql attack 
		//prepares statment
	...
	public function userLogin($email,$password){
		...
		if ($result->num_rows < 1) {
			...
			if (password_verify($password,$row["password"])) {
				...
				//Disini untuk update waktu user last login ketika user login kembali
